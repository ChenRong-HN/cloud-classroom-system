  ...
  <section>
    ...
    >
      ...
      >
        ...
        >
        <el-button icon="el-icon-refresh" @click="resetSearch">重置
        </el-button
        >
    ...
    >
      ...
      >
      <el-table-column prop="name" label="明细名称"/>
      <el-table-column
          prop="sequence"
          label="排序号"
      />
...
export default {
  ...
  methods: {
    emptyForm() {
      return {id: null, parentId: null, name: "", sequence: 0, intro: ""};
    },
      ...
      this.$refs.form.validate(async (valid) => {
        ...
        try {
          const request = this.form.id
              ? this.$http.put("/system/systemdictionary", this.form)
              : this.$http.post("/system/systemdictionary", this.form);
